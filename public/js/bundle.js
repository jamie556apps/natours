...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFtaWU1NTYiLCJhIjoiY2syNjdhdTB3MXJlMDNnbnl5dW83c2ZpZiJ9.sgSIxXAHL4rr6Z_tPsS7rA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', _context.t0.reponse.data.message);
...
var updateSettingsElement = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookTourElement = document.getElementById('book-tour'); //VALUES
// CALL MAPBOX
...
if (updateSettingsElement) {
  updateSettingsElement.addEventListener('submit', function (e) {
    e.preventDefault();
